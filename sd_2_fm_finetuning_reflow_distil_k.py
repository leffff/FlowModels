...
model_name = "SD 2.1 Reflow 2 + Distill Kandinsky4.0 dataset fp32"
...
def flow_matching_loss(student_model, x_0, x_1, t, encoder_hidden_states):
    student_pred = student_model(x_0, t, encoder_hidden_states=encoder_hidden_states).sample
    
    return F.mse_loss(x_0 + student_pred, x_1, reduction="mean")


def generate(unet, vae, x_0, encoder_hidden_states, n_steps: int = 1, device: str = "cuda"):
    unet.to(device)
    vae.to(device)
    unet.eval()
    vae.eval()
...
teacher_unet.load_state_dict(torch.load(f"/home/jovyan/shares/SR004.nfs2/novitskiy/instructflow/checkpoints/sd_2_1_rf_2_generation_v1/{last_checkpoint}"))
print(f"LOADING /home/jovyan/shares/SR004.nfs2/novitskiy/instructflow/checkpoints/sd_2_1_rf_2_generation_v1/{last_checkpoint} as teacher")

last_checkpoint = os.listdir("/home/jovyan/shares/SR004.nfs2/novitskiy/instructflow/checkpoints/sd_2_1_rf_distill_generation_v1")[-1]
student_unet.load_state_dict(torch.load(f"/home/jovyan/shares/SR004.nfs2/novitskiy/instructflow/checkpoints/sd_2_1_rf_distill_generation_v1/{last_checkpoint}"))
print(f"LOADING /home/jovyan/shares/SR004.nfs2/novitskiy/instructflow/checkpoints/sd_2_1_rf_distill_generation_v1/{last_checkpoint} as student")
